...
<div class="hero-wrap hero-bread" style="background-image: url({{ asset('home-asset/images/home.jpg') }});">
  <div class="container-fluid" style="background-color: rgba(0, 0, 0, 0.2); padding: 13em 0;">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-12 ftco-animate text-center">
        <h1 class="mb-2 text-light display-3">Kami Siap Membantu Anda !</h1>
        <h2 class="subheading mb-4 text-light">Penyedia Alat Kesehatan & Medis No. 1 di Indonesia</h2>
        <p><a href="{{ route('product.index') }}" class="btn btn-danger">
            Shop Now
          </a></p>
      </div>
    </div>
    ...
    <div class="row no-gutters ftco-services">
      ...
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            <h3 class="heading">Produk Aman</h3>
            <span>Jaminan Barang Terbungkus Aman</span>
          </div>
        </div>
      </div>
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            <h3 class="heading">Kualitas Unggulan</h3>
            <span>Produk Dijamin Berkualitas</span>
          </div>
        </div>
      </div>
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            <h3 class="heading">Dukungan 24/7</h3>
            <span>Kami Siap Membantu Setiap Saat</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-3 pb-3">
      <div class="col-md-12 heading-section text-center ftco-animate">
        ...
        <p>Penyedia Alat Kesehatan No.1 di Indonesia</p>
      </div>
    </div>
  </div>
  <div class="container">
