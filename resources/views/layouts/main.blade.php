...
<head>
  <title>Wellness Store | E-Commerce Alat Kesehatan</title>
  <meta charset="utf-8">
...
<body class="goto-here">
        ...
        <div class="col-lg-12 d-block">
          <div class="row d-flex">
            <div class="col-md pr-4 d-flex topper align-items-center">
              ...
              <span class="text">+62 123-4567-8910</span>
            </div>
            <div class="col-md pr-4 d-flex topper align-items-center">
              <div class="icon mr-2 d-flex justify-content-center align-items-center">
                <span class="icon-paper-plane"></span>
              </div>
              <span class="text">wellnesstore@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="{{ route('home') }}">Wellness Store</a>
  ...
  <section class="ftco-section ftco-no-pt ftco-no-pb py-5" style="background: rgb(225, 231, 235);">
    <div class="container py-4">
      <div class="row d-flex justify-content-center py-5">
        <div class="col-md-6">
          <h2 style="font-size: 3rem;" class="mb-0">Segera Daftar</h2>
          <span>Untuk mendapatkan produk terbaik dari kami !</span>
        </div>
        <div class="col-md-6 d-flex align-items-center justify-content-center">
          <a href="{{ route('register') }}" class="btn btn-danger px-5 py-3">
            Register Now
          </a>
        </div>
      </div>
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2">Wellness Store</h2>
            <p>Tempat Terbaik Untuk Mendapatkan Alat Kesehatan & Medis</p>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                <li>
                  <span class="icon icon-map-marker"></span><span class="text">Jl. Gubeng Masjid, Pacarkeling, Kec. Tambaksari, 60131</span>
                </li>
                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+62 123-4567-8910</span></a></li>
                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">wellnesstore@gmail.com</span></a>
                </li>
              </ul>
            </div>
          </div>
